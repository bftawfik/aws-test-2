                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    more of the shares, equity interest, or
                                    other securities entitled to vote for the
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    EstateBook, New Cairo, Cairo, Egypt.
                                </span>
                            </span>
                        </span>
                    </li>
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    such as a computer, a cellphone, or a
                                    digital tablet.
                                </span>
                            </span>
                        </span>
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    assist the Company in analyzing how the
                                    Service is used.
                                </span>
                            </span>
                        </span>
                    ...
                    <li>
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    {' '}
                                    refers to EstateBook, accessible from{' '}
                                </span>
                                <a href="http://estatebook.com/">
                                    <span style={{ fontSize: '12pt' }}>
                                        <span style={{ color: '#553df4' }}>
                                            https://estatebook.com/
                                        </span>
                                    </span>
                                </a>
                            </span>
                            ...
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                <span style={{ fontSize: '12pt' }}>
                                    <span style={{ color: 'black' }}>
                                        ...
                                        device's unique ID, the IP address of
                                        Your mobile device, Your mobile
                                        operating system, the type of mobile
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    events which we offer that are similar to
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    of our promotional campaigns, and to
                        ...
                        <span style={{ fontSize: '11pt' }}>
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                ...
                                <span style={{ fontSize: '12pt' }}>
                                    ...
                                    otherwise interact in public areas with
                            ...
                            <span style={{ fontFamily: 'Arial, sans-serif' }}>
                                <span style={{ fontSize: '12pt' }}>
                                    <span style={{ color: 'black' }}>
                                        ...
                                        laws may differ from those from Your
                                        jurisdiction.
                                    </span>
                                </span>
                            </span>
