...
interface NeighborhoodGallerySectionSSRProps {
    images: string[];
    outerView?: string;
}

const NeighborhoodGallerySectionSSR = ({
    images,
    outerView = 'gallery',
}: NeighborhoodGallerySectionSSRProps) => {
    // Read localization
...
export default NeighborhoodGallerySectionSSR;
